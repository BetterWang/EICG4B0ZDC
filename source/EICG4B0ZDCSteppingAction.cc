...
//____________________________________________________________________________..
EICG4B0ZDCSteppingAction::EICG4B0ZDCSteppingAction(EICG4B0ZDCDetector *detector, const PHParameters *parameters)
...
//____________________________________________________________________________..
EICG4B0ZDCSteppingAction::~EICG4B0ZDCSteppingAction()
{
...
bool EICG4B0ZDCSteppingAction::UserSteppingAction(const G4Step *aStep,bool was_used)
{
...
void EICG4B0ZDCSteppingAction::SetInterfacePointers(PHCompositeNode *topNode)
{
  ...
  if (!m_HitContainer)
  {
    std::cout << "EICG4B0ZDCSteppingAction::SetTopNode - unable to find "
